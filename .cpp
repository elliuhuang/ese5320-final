...
#define STAGES (4)
#define PACKET_SIZE 16386

int main(int argc, char *argv[])
{
  unsigned char *Input_packet = (unsigned char *)malloc(PACKET_SIZE);

  //DO LATER ONCE WE KNOW COMPRESSED SIZED????
  unsigned char *Output_data = (unsigned char *)malloc(PACKET_SIZE);

//NOT SURE WHAT THIS DOES????
   Load_data(Input_packet);
